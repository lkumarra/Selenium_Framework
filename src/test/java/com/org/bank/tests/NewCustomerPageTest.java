...
public class NewCustomerPageTest {
    ...
    @Test(testName = "Verify new customer heading", description = "Verify Add new customer heading", groups = {"@all", "@smoke", "@newCustomer"}, priority = 10)
    protected void test_add_customer_heading_message() {
        ...
        softAssert.assertEquals(actualHeading, expectedHeading, String.format("Actual heading is : %s and expected is : %s", actualHeading, expectedHeading));
    }

    @Test(testName = "Verify new customer label's", description = "Verify label's on new customer page", groups = {"@all", "@sanity", "@newCustomer"}, priority = 11)
    protected void test_new_customer_page_fields_labels() {
        ...
        softAssert.assertEquals(actualLabel, expectedLabel, String.format("Actual fields label are : %s and expected fields labels are : %s", actualLabel, expectedLabel));
    }

    @Test(testName = "Verify customer name field", description = "Verify customer label fields validations", groups = {"@all", "@smoke", "@newCustomer"}, priority = 12)
    protected void test_customer_field_validations() {
        ...
        Assert.assertEquals(actualLabel, expectedLabel, String.format("Actual messages are : %s and expected messages are : %s", actualLabel, expectedLabel));
    }

    @Test(testName = "Verify dob field", description = "Verify dob field validations", groups = {"@all", "@sanity", "@newCustomer"}, priority = 13)
    ...
    @Test(testName = "Verify address field", description = "Verify address field validations", groups = {"@all", "@smoke", "@newCustomer"}, priority = 14)
    ...
    @Test(testName = "Verify city field", description = "Verify city field validations", groups = {"@all", "@sanity", "@newCustomer"}, priority = 15)
    ...
    @Test(testName = "Verify state field", description = "Verify state field validations", groups = {"@all", "@smoke", "@newCustomer"}, priority = 16)
    ...
    @Test(testName = "Verify pin field", description = "Verify pin field validations", groups = {"@all", "@sanity", "@newCustomer"}, priority = 17)
    ...
    @Test(testName = "Verify mobile field", description = "Verify mobile field validations", groups = {"@all", "@smoke", "@newCustomer"}, priority = 18)
    ...
    @Test(testName = "Verify password field", description = "Verify password field validations", groups = {"@all", "@sanity", "@newCustomer"}, priority = 19)
    ...
    @Test(testName = "Verify email field", description = "Verify email field validations", groups = {"@all", "@smoke", "@newCustomer"}, priority = 20)
    ...
    @Test(testName = "Verify customer name field with data provider", description = "Verify customer label fields validations with data provider", groups = {"@all", "@smoke", "@newCustomer"}, priority = 21, dataProvider = "customerField")
